-- ==========================================
-- INSERCIÓN DE EJERCICIOS COMPLETOS
-- ==========================================
-- Este script inserta una biblioteca completa de ejercicios
-- organizados por grupo muscular y equipo

-- ==========================================
-- PASO 1: Verificar y agregar columna category si no existe
-- ==========================================
...
-- Limpiar ejercicios existentes del sistema (opcional, comentar si quieres mantener los actuales)
...
('Aperturas en Polea (Cable Fly)', 'Fuerza', 'Pecho', 'Poleas', 'Tensión constante en todo el rango de movimiento', false),
('Fondos en Paralelas', 'Fuerza', 'Pecho', 'Peso Corporal', 'Excelente para pecho inferior y tríceps', false),
('Flexiones (Push-ups)', 'Fuerza', 'Pecho', 'Peso Corporal', 'Ejercicio básico efectivo para pecho', false),
...
('Peck Deck (Mariposa)', 'Fuerza', 'Pecho', 'Máquina', 'Aislamiento del pecho', false),
...
INSERT INTO exercises (name, category, muscle_group, equipment, description, is_custom) VALUES
('Dominadas (Pull-ups)', 'Fuerza', 'Espalda', 'Peso Corporal', 'Ejercicio rey para desarrollo de espalda', false),
('Dominadas Supinas (Chin-ups)', 'Fuerza', 'Espalda', 'Peso Corporal', 'Mayor activación de bíceps', false),
('Remo con Barra', 'Fuerza', 'Espalda', 'Barra', 'Fundamental para grosor de espalda', false),
('Remo con Mancuerna a Una Mano', 'Fuerza', 'Espalda', 'Mancuernas', 'Aislamiento unilateral de espalda', false),
...
('Jalón con Agarre Cerrado', 'Fuerza', 'Espalda', 'Poleas', 'Mayor activación del dorsal inferior', false),
...
-- ==========================================
-- EJERCICIOS DE PIERNAS - CUÁDRICEPS
-- ==========================================

INSERT INTO exercises (name, category, muscle_group, equipment, description, is_custom) VALUES
('Sentadilla Libre (Back Squat)', 'Fuerza', 'Cuádriceps', 'Barra', 'Ejercicio rey para desarrollo de piernas', false),
('Sentadilla Frontal (Front Squat)', 'Fuerza', 'Cuádriceps', 'Barra', 'Mayor activación de cuádriceps', false),
...
-- ==========================================
-- EJERCICIOS DE PIERNAS - ISQUIOTIBIALES
-- ==========================================

INSERT INTO exercises (name, category, muscle_group, equipment, description, is_custom) VALUES
('Peso Muerto con Piernas Rígidas', 'Fuerza', 'Isquiotibiales', 'Barra', 'Enfoque en isquiotibiales', false),
...
('Buenos Días (Good Mornings)', 'Fuerza', 'Isquiotibiales', 'Barra', 'Fortalecimiento de cadena posterior', false),
...
('Patada de Glúteo en Polea', 'Fuerza', 'Glúteos', 'Poleas', 'Aislamiento de glúteos', false),
('Abducción de Cadera en Máquina', 'Fuerza', 'Glúteos', 'Máquina', 'Trabajo de glúteo medio', false),
('Zancadas Inversas', 'Fuerza', 'Glúteos', 'Mancuernas', 'Mayor activación de glúteos que zancadas frontales', false);
...
INSERT INTO exercises (name, category, muscle_group, equipment, description, is_custom) VALUES
('Press Militar con Barra', 'Fuerza', 'Hombros', 'Barra', 'Ejercicio fundamental para hombros', false),
('Press con Mancuernas Sentado', 'Fuerza', 'Hombros', 'Mancuernas', 'Mayor rango de movimiento', false),
...
('Pájaros (Rear Delt Fly)', 'Fuerza', 'Hombros', 'Mancuernas', 'Desarrollo del deltoides posterior', false),
...
('Elevaciones Laterales en Polea', 'Fuerza', 'Hombros', 'Poleas', 'Tensión constante en laterales', false),
...
('Curl en Polea Baja', 'Fuerza', 'Bíceps', 'Poleas', 'Tensión constante', false),
...
INSERT INTO exercises (name, category, muscle_group, equipment, description, is_custom) VALUES
('Press de Banca Agarre Cerrado', 'Fuerza', 'Tríceps', 'Barra', 'Compuesto para tríceps', false),
('Extensiones de Tríceps Acostado', 'Fuerza', 'Tríceps', 'Barra Z', 'Aislamiento de tríceps (skullcrushers)', false),
('Extensiones de Tríceps en Polea', 'Fuerza', 'Tríceps', 'Poleas', 'Tensión constante', false),
...
('Fondos en Paralelas', 'Fuerza', 'Tríceps', 'Peso Corporal', 'Excelente ejercicio compuesto', false),
('Press Francés', 'Fuerza', 'Tríceps', 'Barra Z', 'Desarrollo de cabeza larga', false),
('Extensiones Overhead con Mancuerna', 'Fuerza', 'Tríceps', 'Mancuernas', 'Estiramiento de cabeza larga', false);

-- ==========================================
-- EJERCICIOS DE ABDOMEN/CORE
-- ==========================================

INSERT INTO exercises (name, category, muscle_group, equipment, description, is_custom) VALUES
('Crunch Abdominal', 'Fuerza', 'Abdomen', 'Peso Corporal', 'Ejercicio básico para abdominales', false),
('Plancha (Plank)', 'Fuerza', 'Abdomen', 'Peso Corporal', 'Fortalecimiento isométrico del core', false),
('Plancha Lateral', 'Fuerza', 'Abdomen', 'Peso Corporal', 'Trabajo de oblicuos', false),
('Elevación de Piernas Colgado', 'Fuerza', 'Abdomen', 'Peso Corporal', 'Trabajo intenso de abdomen inferior', false),
('Elevación de Rodillas Colgado', 'Fuerza', 'Abdomen', 'Peso Corporal', 'Versión más fácil de elevación de piernas', false),
...
('Ab Wheel (Rueda Abdominal)', 'Fuerza', 'Abdomen', 'Rueda Ab', 'Ejercicio avanzado para core completo', false),
...
INSERT INTO exercises (name, category, muscle_group, equipment, description, is_custom) VALUES
('Curl de Muñeca con Barra', 'Fuerza', 'Antebrazos', 'Barra', 'Desarrollo de flexores del antebrazo', false),
...
-- Verificar cuántos ejercicios se insertaron
SELECT
    muscle_group,
